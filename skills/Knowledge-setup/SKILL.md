...
Use this skill when the user asks to initialize, adopt, set up, refresh, or repair the repo context layer for a repo. This is a manual trigger, not a background automation. The manual trigger phrase is: `Use $Knowledge-setup in this repo`.
