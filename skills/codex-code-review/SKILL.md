...
description: Use when the user asks for repository code review, deep review, multi-agent review, specialist review, security review, test review, performance review, architecture review, type-contract review, or plan-alignment review. Review only by default; do not apply fixes unless explicitly asked.
---
