...
Codex Code Review for normal software repositories.
...
Ask for `codex-code-review` when you want a review-only pass over a PR, branch, or diff. The default output is findings and coverage evidence, not code changes.
