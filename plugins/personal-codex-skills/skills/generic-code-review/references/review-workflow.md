...
4. Do not assume any private docs MCP, external docs folder, plan plan, or product-specific source of truth.
...
```text
GCR-<branch-slug>-<agent-slug>-<three-digit-number>
```
